...
public class Examination {
    ...
    public static void end() {
        ...
        System.out.println("");
        System.out.println("---------------执行用时：" + time.substring(0,time.equals("0.0") ? 1 : (time.indexOf(".")+3)) + " ms, 内存消耗：" + memory.substring(0,memory.equals("0.0") ? 1 : (memory.indexOf(".")+3)) + " MB ---------------");
    }
